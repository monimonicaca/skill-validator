...
4. Review the skill against the 7 quality checks:
   - format correctness
   - triggerability
...
- **Pass**: required files exist, frontmatter parses, the description triggers correctly, the workflow is complete, instructions are executable, ambiguity is low, test cases exist, and the skill follows best practices.
